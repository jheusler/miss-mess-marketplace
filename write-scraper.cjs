// write-scraper.cjs
// Generates scraper-test.mjs, which:
//   1. Navigates to EstateSales.net STL page
//   2. Intercepts the byids API call (real listing data)
//   3. Transforms + saves results to public/sales.json
// Run with: node write-scraper.cjs && node scraper-test.mjs
...
fs.writeFileSync("scraper-test.mjs", code.trim());
console.log("scraper-test.mjs written successfully");
